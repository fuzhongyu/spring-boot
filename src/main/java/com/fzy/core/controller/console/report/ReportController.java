...
public class ReportController extends BaseController {
    ...
    public ResponseResult lineChartLoad(@PathVariable("id") Long id, @RequestParam("conditionDataStr") String conditionDataStr) {
    ...
    public ResponseResult load(@PathVariable("id") Long id,
                              ...
                              @RequestParam("conditionDataStr") String conditionDataStr) {

 ...
 * snowflake生成的ID
 *
 * from: http://blog.csdn.net/antony9118/article/details/52766848
 * @author Fucai
 * @date 2018/3/19
 */
public class IdWorker {
    ...
    /**
     * 开始该类生成ID的时间截，1521467903000 (2019-03-19)
     * 这一时刻到当前时间所经过的毫秒数，占 41 位（还有一位是符号位，永远为 0）
     */
    private final long startTime = 1521467903000L;
     ...
     * （不信的话可以自己算一下，记住，计算机中存储一个数都是存储的补码，结果是负数要从补码得到原码）
     */
